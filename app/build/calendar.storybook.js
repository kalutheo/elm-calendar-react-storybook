...
var _user$project$Calendar_Utils$monthNames = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Jan, _1: 'January'},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Feb, _1: 'February'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Mar, _1: 'March'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Apr, _1: 'April'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$May, _1: 'May'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Jun, _1: 'June'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Jul, _1: 'July'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Aug, _1: 'August'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Sep, _1: 'September'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Oct, _1: 'October'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Nov, _1: 'November'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: _elm_lang$core$Date$Dec, _1: 'December'},
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Calendar_Utils$getMonthNameByIndex = function (selectedMonthIndex) {
	var maybeMonth = A2(
		_elm_lang$core$Array$get,
		selectedMonthIndex,
		_elm_lang$core$Array$fromList(_user$project$Calendar_Utils$monthNames));
	var _p0 = maybeMonth;
	if (_p0.ctor === 'Just') {
		return _elm_lang$core$Tuple$second(_p0._0);
	} else {
		return '';
	}
};
var _user$project$Calendar_Utils$dayPerWeek = 7;
var _user$project$Calendar_Utils$monthDates = F2(
	function (y, m) {
		var start = A2(
...
var _user$project$Calendar_Utils$chunk = F2(
	function (n, list) {
		return _elm_lang$core$List$isEmpty(list) ? {ctor: '[]'} : {
			ctor: '::',
			_0: A2(_elm_lang$core$List$take, n, list),
			_1: A2(
				_user$project$Calendar_Utils$chunk,
				n,
				A2(_elm_lang$core$List$drop, n, list))
		};
	});
var _user$project$Calendar_Utils$oneOf = function (maybes) {
	oneOf:
	while (true) {
		var _p1 = maybes;
		if (_p1.ctor === '[]') {
...
var _user$project$Calendar_Model$model = {
	...
	selectedStartDay: _elm_lang$core$Maybe$Nothing,
	selectedEndDay: _elm_lang$core$Maybe$Nothing,
	hoveredDay: _elm_lang$core$Maybe$Nothing,
	currentDates: A2(_user$project$Calendar_Utils$monthDates, 2016, _elm_lang$core$Date$Oct)
};
var _user$project$Calendar_Model$Model = F5(
	function (a, b, c, d, e) {
		return {selectedMonthIndex: a, selectedStartDay: b, selectedEndDay: c, hoveredDay: d, currentDates: e};
	});
var _user$project$Calendar_Model$Hovered = {ctor: 'Hovered'};
var _user$project$Calendar_Model$Selected = {ctor: 'Selected'};
var _user$project$Calendar_Model$Disabled = {ctor: 'Disabled'};
var _user$project$Calendar_Model$Dimmed = {ctor: 'Dimmed'};
var _user$project$Calendar_Model$Normal = {ctor: 'Normal'};

var _user$project$Calendar_Msg$BlurDay = function (a) {
	return {ctor: 'BlurDay', _0: a};
};
var _user$project$Calendar_Msg$HoverDay = function (a) {
	return {ctor: 'HoverDay', _0: a};
};
var _user$project$Calendar_Msg$SelectDay = function (a) {
	return {ctor: 'SelectDay', _0: a};
};

var _user$project$Calendar_View$selectedDayLabelView = F2(
	function (title, day) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('select-date-label'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Maybe$withDefault, '', day)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Calendar_View$calenderHeader = function (title) {
	return A2(
			...
			_elm_lang$html$Html$td,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Calendar_Msg$SelectDay(date)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseOver(
							_user$project$Calendar_Msg$HoverDay(date)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseOut(
								_user$project$Calendar_Msg$BlurDay(date)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Calendar_View$calendarRow = F2(
...
var _user$project$Calendar_View$calendarView = function (model) {
	var endDay = A2(
		_elm_lang$core$Maybe$map,
		_justinmimbs$elm_date_extra$Date_Extra$toFormattedString('MMMM d, y'),
		model.selectedEndDay);
	var startDay = A2(
		_elm_lang$core$Maybe$map,
		_justinmimbs$elm_date_extra$Date_Extra$toFormattedString('MMMM d, y'),
		model.selectedStartDay);
	var weeks = A2(_user$project$Calendar_Utils$chunk, _user$project$Calendar_Utils$dayPerWeek, model.currentDates);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Calendar_View$calenderHeader(
						_user$project$Calendar_Utils$getMonthNameByIndex(model.selectedMonthIndex)),
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								function (row) {
									return A2(_user$project$Calendar_View$calendarRow, row, model);
								},
								weeks)),
						_1: {ctor: '[]'}
					}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Calendar_View$selectedDayLabelView, 'Start Date : ', startDay),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Calendar_View$selectedDayLabelView, 'End Date : ', endDay),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
